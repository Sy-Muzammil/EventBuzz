        ...
        <div class="container">
            ...
            <div class="mbr-table">
                ...
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar"><li class="nav-item"><a class="nav-link link" data-toggle="modal" data-target="#login" href="#">Bid</a></li><li class="nav-item"><a class="nav-link link" href="EventProfile.php">CSA</a></li><li class="nav-item "><a class="nav-link link " href="DisplayEvents.php">Buy</a><li class="nav-item "><a class="nav-link link" href="OrganiserEventList.php" >My Events</a></li><li class="nav-item dropdown"><a class="nav-link link dropdown-toggle" data-toggle="dropdown-submenu" href="#" aria-expanded="false">Account</a><div class="dropdown-menu"><a class="dropdown-item" href="UserProfile.php">Profile</a><a class="dropdown-item" href="12_consumerMap.php">Connect More</a><a class="dropdown-item" href="logout.php">logout</a></div></li></ul>
